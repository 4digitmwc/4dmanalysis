...
_4dm_dataset = Dataset("datasets/4dm3.db")
...
cf_db = sqlite3.connect("4dm3_cf.db")
...
predicted_value.to_csv("4dm3_user_cf_predict.csv")
...
predict_Item_value.to_csv("4dm3_item_cf_predict.csv")
